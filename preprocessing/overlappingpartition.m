function [elem2cpu,extintelem,extintelempts,face2cpu,extintface,extintfacepts,ent2cpu,extintent,extintentpts,outelem] =...
         overlappingpartition(t2f,t,elcon,f,hybrid,overlappinglevel,nproc,check)
...
if numEntities ~= length(unique(t2f(:))); error('It looks like there are ghost entities in the mesh.'); end
