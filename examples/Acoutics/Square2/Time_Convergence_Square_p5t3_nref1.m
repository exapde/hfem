...
load('C:\Users\Lauren\Dropbox (MIT)\DIGASO\err_p5_nref1_K1_dt0004.mat')
load('C:\Users\Lauren\Dropbox (MIT)\DIGASO\err_p5_nref1_K1_dt0004_imp.mat')
...
load('C:\Users\Lauren\Dropbox (MIT)\DIGASO\err_p5_nref1_K1_dt0005.mat')
% load('Sq_Ref_Solution_Simplified.mat')
...
%% dt = 0.0017
% load('/home/lkolkman/Dropbox (MIT)/DIGASO/err_p5_nref1_K1_dt0007.mat')
load('C:\Users\Lauren\Dropbox (MIT)\DIGASO\err_p5_nref1_K1_dt0007.mat')
...
load('C:\Users\Lauren\Dropbox (MIT)\DIGASO\err_p5_nref1_K1_dt0009.mat')
...
load('C:\Users\Lauren\Dropbox (MIT)\DIGASO\err_p5_nref1_K1_dt0020.mat')
...
dt = [0.0004; 0.0005; 0.0007; 0.0009; 0.0020];
...
%%%%%%%%%%%%%%%%%% u Plot %%%%%%%%%%%%%%%%%%
figure()
loglog(dt,Q,'-s','Color',[148/255,0,211/255]);
