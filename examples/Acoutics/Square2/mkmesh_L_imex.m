...
nodes3 = linspace(0,0.5,m2)';
nodes4 = linspace(0.5,1,m2)';
...
neven = length(nodes_even);
n2 = length(nodes1);
n3 = m2;

pv1 = [nodes_even zeros(neven,1); ones(neven-1,1) nodes_even(2:end); nodes4(end-1:-1:1) ones(n3-1,1); mid(2:end) nodes2(end-1:-1:1); nodes1(end-1:-1:1) mid(2:end) ;zeros(n3-2,1) nodes3(end-1:-1:2)];
