...
torder = 3;
hybrid = 'hdg';
nref = 4 ; % nref = 1 is no refinements
...
% mesh.fimex = []; meshEX = mesh; meshIM = mesh; % TO BE SUPPRESSED !!!!
...
erruimp1 = calerror(vstarIM,meshIM1,master1,@exactsol,itime*dt);
erruexp1 = calerror(vstarEX,meshEX1,master1,@exactsol,itime*dt);
