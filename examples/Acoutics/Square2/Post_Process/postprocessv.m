function vstar = postprocessv(master,mesh,master1,mesh1,v,vh)
...
shapxi = squeeze(master.shapvt(:,:,2))'*diag(master.gwvl);
shapet = squeeze(master.shapvt(:,:,3))'*diag(master.gwvl);
