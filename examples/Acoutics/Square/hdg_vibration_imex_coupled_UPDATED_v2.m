function UDG = hdg_vibration_imex_coupled_UPDATED_v2(master,mesh,app,VDGn,Un,tn,dt,nstage,torder,Minv)
...
% check UDG 
    [UHAT,B,G,D] = ehdgrk_imex_coupled_BG(master,mesh,app,Minv,UDGo, i,istage);
