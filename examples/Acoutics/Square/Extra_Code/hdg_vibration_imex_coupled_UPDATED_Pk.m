function UDG = hdg_vibration_imex_coupled_UPDATED_Pk(master,mesh,app,VDGn,Un,tn,dt,nstage,torder,Minv)
...
for istage = 1:nstage % for each dirk stage    
    ...
    % compute (v,q,vhat)
    [VDGni,VHni] = hdg_solve(master,mesh,app,SDG,fc,tni, VDGni, Minv);
...
function [VDG,VH] = hdg_solve(master, mesh, app, SDG, fc, time, UDG, Minv)
%
