...
plocal_bary = zeros(size(master.plocvl,1),3);
plocal_bary(:,1) = 1 - master.plocvl(:,1) - master.plocvl(:,2);
plocal_bary(:,2:3) = master.plocvl(:,1:2);


% shapt = shape2d(master.porder,master.plocal,master1.gpts);
shapt = shape2d(master.porder,plocal_bary,master1.gpvl);
