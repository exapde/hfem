...
elseif (icase ==5)
    udg = l2eprojection(mesh,master,@exactsolvortex,[],0,7); 
elseif (icase == 6)
    udg = l2eprojection(mesh,master,@initKH,[],[],7);
elseif (icase == 2)
    udg = l2eprojection(mesh,master,@initOT,[],[],7);
elseif (icase == 3)
    udg = l2eprojection(mesh,master,@initRotor,[],[],7);
end
