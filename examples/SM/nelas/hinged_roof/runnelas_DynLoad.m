...
app.ptsource.ibpl = [4];
app.ptsource.ampl = 750./mu0;
app.ptsource.surf = 1;
Pmax = app.ptsource.ampl;
...
lambda = 0.; Dlambda = 0.05;
Nit1 = 20; it = 1; Nref = 1; NitMax = 60;
