...
% mesh.hybrid = 'hdg';
% [mesh.f,mesh.t2f] = mkt2f(mesh.t,mesh.elemtype);
% elcon = elconnectivities(mesh);
...
%             i2 = kf(1,:)==i;  % obtain the index of face i in the second element        
%             dg2 = mesh.dgnodes(perm(j1,i2),1:nd,fi(2));   
% 
%             j2 = xiny(dg2,dg1)    
%             j2 = [1     6    10    13    15     2     7    11    14     3     8    12     4     9     5]';
