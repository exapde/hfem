...
function [mesh,meshp] = justWriteBinaryFile(filename,mesh,master,app,UDG,UH,PDG,nproc,meshp)
...
elseif nproc > 1
    ...
    for i = 1:nproc
        ...
        ndims(48) = length(mesh.cbsr_rowpts(:));
        ndims(49) = length(mesh.cbsr_colind(:));
