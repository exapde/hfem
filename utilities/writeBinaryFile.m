...
% globalEnt2entWeight = fread(fileID,length(mesh.globalEnt2ent),'double',endian);
% fclose(fileID);
...
%     meshp{i}.ent2entWeight = fread(fileID,meshp{i}.BJ_nblks+meshp{i}.BK_nblks,'double',endian);
%     fclose(fileID);
%     
