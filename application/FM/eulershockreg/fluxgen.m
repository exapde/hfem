...
if nd==2                                               
    ...
    h    = E+pt*r1;    
    f2   = [ru, ru*uv+pt, rv*uv,   ru*h, ...
            rv, ru*vv,   rv*vv+pt, rv*h];            
...
for n=1:4
    ...
    elseif n==3
        f = f3;
        filename1 = ['flux' num2str(nd) 'd3' '.m'];    
    elseif n==4
        f = f4;
        filename1 = ['flux' num2str(nd) 'd4' '.m'];
    end
