void getan2d(double *An, double *Anm, double *uh, double *nl, double *param, int absflag, int ng)
{
    ...
    for (i=0; i<ng; i++) { 
        ...
        An[4*ng+i] = cc1;
        An[5*ng+i] = rlam3+cc1*uv+cc2*nx;
        An[6*ng+i] = cc1*vv+cc2*ny;
        An[7*ng+i] = cc1*h+cc2*un;                        
        Anm[4*ng+i] = cc1m1;
        Anm[5*ng+i] = rlam3m1+cc1m1*uv+cc1*uvm1+cc2m1*nx;
        Anm[6*ng+i] = cc1m1*vv+cc1*vvm1+cc2m1*ny;
        Anm[7*ng+i] = cc1m1*h+cc1*hm1+cc2m1*un+cc2*unm1;                        
        Anm[20*ng+i] = cc1m2;
        Anm[21*ng+i] = rlam3m2+cc1m2*uv+cc1*uvm2+cc2m2*nx;
        Anm[22*ng+i] = cc1m2*vv+cc1*vvm2+cc2m2*ny;
        Anm[23*ng+i] = cc1m2*h+cc1*hm2+cc2m2*un+cc2*unm2;                                
        Anm[36*ng+i] = cc1m3;
        Anm[37*ng+i] = rlam3m3+cc1m3*uv+cc1*uvm3+cc2m3*nx;
        Anm[38*ng+i] = cc1m3*vv+cc1*vvm3+cc2m3*ny;
        Anm[39*ng+i] = cc1m3*h+cc1*hm3+cc2m3*un+cc2*unm3;                        
        Anm[52*ng+i] = cc1m4;
        Anm[53*ng+i] = rlam3m4+cc1m4*uv+cc1*uvm4+cc2m4*nx;
        Anm[54*ng+i] = cc1m4*vv+cc1*vvm4+cc2m4*ny;
        ...
        An[8*ng+i] = cc1;
        An[9*ng+i] = cc1*uv+cc2*nx;
        An[10*ng+i] = rlam3+cc1*vv+cc2*ny;
        An[11*ng+i] = cc1*h+cc2*un;                        
        Anm[8*ng+i] = cc1m1;
        Anm[9*ng+i] = cc1m1*uv+cc1*uvm1+cc2m1*nx;
        Anm[10*ng+i] = rlam3m1+cc1m1*vv+cc1*vvm1+cc2m1*ny;
        Anm[11*ng+i] = cc1m1*h+cc1*hm1+cc2m1*un+cc2*unm1;                        
        Anm[24*ng+i] = cc1m2;
        Anm[25*ng+i] = cc1m2*uv+cc1*uvm2+cc2m2*nx;
        Anm[26*ng+i] = rlam3m2+cc1m2*vv+cc1*vvm2+cc2m2*ny;
        Anm[27*ng+i] = cc1m2*h+cc1*hm2+cc2m2*un+cc2*unm2;                                
        Anm[40*ng+i] = cc1m3;
        Anm[41*ng+i] = cc1m3*uv+cc1*uvm3+cc2m3*nx;
        Anm[42*ng+i] = rlam3m3+cc1m3*vv+cc1*vvm3+cc2m3*ny;
        Anm[43*ng+i] = cc1m3*h+cc1*hm3+cc2m3*un+cc2*unm3;                        
        Anm[56*ng+i] = cc1m4;
        Anm[57*ng+i] = cc1m4*uv+cc1*uvm4+cc2m4*nx;
        Anm[58*ng+i] = rlam3m4+cc1m4*vv+cc1*vvm4+cc2m4*ny;
        ...
        An[12*ng+i] = cc1;
        An[13*ng+i] = cc1*uv+cc2*nx;
        An[14*ng+i] = cc1*vv+cc2*ny;
        An[15*ng+i] = rlam3+cc1*h+cc2*un;                        
        Anm[12*ng+i] = cc1m1;
        Anm[13*ng+i] = cc1m1*uv+cc1*uvm1+cc2m1*nx;
        Anm[14*ng+i] = cc1m1*vv+cc1*vvm1+cc2m1*ny;
        Anm[15*ng+i] = rlam3m1+cc1m1*h+cc1*hm1+cc2m1*un+cc2*unm1;                        
        Anm[28*ng+i] = cc1m2;
        Anm[29*ng+i] = cc1m2*uv+cc1*uvm2+cc2m2*nx;
        Anm[30*ng+i] = cc1m2*vv+cc1*vvm2+cc2m2*ny;
        Anm[31*ng+i] = rlam3m2+cc1m2*h+cc1*hm2+cc2m2*un+cc2*unm2;                                
        Anm[44*ng+i] = cc1m3;
        Anm[45*ng+i] = cc1m3*uv+cc1*uvm3+cc2m3*nx;
        Anm[46*ng+i] = cc1m3*vv+cc1*vvm3+cc2m3*ny;
        Anm[47*ng+i] = rlam3m3+cc1m3*h+cc1*hm3+cc2m3*un+cc2*unm3;                        
        Anm[60*ng+i] = cc1m4;
        Anm[61*ng+i] = cc1m4*uv+cc1*uvm4+cc2m4*nx;
        Anm[62*ng+i] = cc1m4*vv+cc1*vvm4+cc2m4*ny;
        Anm[63*ng+i] = rlam3m4+cc1m4*h+cc1*hm4+cc2m4*un+cc2*unm4;                                                                        
    }            
}

void getan3d(double *An, double *Anm, double *uh, double *nl, double *param, int absflag, int ng)
{
    double gam, epslm, gam1, signun, ic;
    double nx, ny, nz;    
...
void getan(double *An, double *Anm, double *uh, double *nl, double *param, int absflag, int ng, int nch, int nd)
{
    switch (nd) {
        case 2 :    
            getan2d(An, Anm, uh, nl, param, absflag, ng);
            break;
        case 3 :            
            getan3d(An, Anm, uh, nl, param, absflag, ng);
            break;
        default :
            break;
    }
...
void getanonly2d(double *An, double *uh, double *nl, double *param, int absflag, int ng)
{    
    double gam, epslm, gam1, signun, ic;
    double nx, ny;    
    double r, ru, rv, rE;          
...
void getanonly3d(double *An, double *uh, double *nl, double *param, int absflag, int ng)
{
...
void getanonly(double *An, double *uh, double *nl, double *param, int absflag, int ng, int nch, int nd)
{
    switch (nd) {
        case 2 :    
            getanonly2d(An, uh, nl, param, absflag, ng);
            break;
        case 3 :            
            getanonly3d(An, uh, nl, param, absflag, ng);
            break;
        default :
            break;
    }
