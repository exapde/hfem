function [An,Anm,un,c] = getan(nl,m,param,absolute)
%FHAT flux function
...
if absolute>1
    ...
    if absolute==2    
        ...
        cfy    = 1;
        cfz    = 0;
        rlam   = cfx*rlam3+cfy*c+cfz*param{5};
        rlamm1 = cfx*rlam3m1+cfy*cm1;
        rlamm2 = cfx*rlam3m2+cfy*cm2;
        rlamm3 = cfx*rlam3m3+cfy*cm3;
        rlamm4 = cfx*rlam3m4+cfy*cm4;                    
    end   
    An      = zeros(ng,nc,nc);
