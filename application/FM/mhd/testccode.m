...
if nd == 2                                               
    ...
    filename1 = ['test_flux_mhd23d.c'];
    filename2 = ['test_source_mhd23d.c'];
    filename3 = ['test_fhat_mhd23d.c'];
else                                         
    r    = udg(1);
    ru   = udg(2);
    rv   = udg(3);
    ...
    filename1 = ['test_flux_mhd3d.c'];
    filename2 = ['test_source_mhd3d.c'];
    filename3 = ['test_fhat_mhd3d.c'];
end
