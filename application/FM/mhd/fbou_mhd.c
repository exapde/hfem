...
#include "fbou_mhd23d.c"
#include "fbou_mhd3d.c"
...
void fbou_mhd(double *f, double *f_udg, double * f_uh, double *pg, double *udg, double *uhg, 
...
{    
    ...
    switch (nd) {
        case 2:            
            fbou_mhd23d(f, f_udg, f_uh, pg, udg, uhg, nl, ui, param, time, ib, numPoints, nc, ncu, nd, ncd);            
            break;
	    
        case 3:            
            fbou_mhd3d(f, f_udg, f_uh, pg, udg, uhg, nl, ui, param, time, ib, numPoints, nc, ncu, nd, ncd);            
            break;
