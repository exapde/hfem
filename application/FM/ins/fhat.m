...
%     fh_uh(:,1,1:nch) = fh_udg(:,1,1:nch);
%     fh_uh(:,2,1:nch) = fh_udg(:,2,1:nch);
%     fh_uh(:,1,1) = fh_uh(:,1,1) - tau;
%     fh_uh(:,2,2) = fh_uh(:,2,2) - tau;    
%     
%     fh_udg(:,1,1:nch) = 0;
%     fh_udg(:,2,1:nch) = 0;
%     fh_udg(:,1,1) = fh_udg(:,1,1) + tau;
%     fh_udg(:,2,2) = fh_udg(:,2,2) + tau;           
% end
