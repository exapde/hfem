void fhat_ledisp3d(double *fh, double *fh_udg, double *fh_uh, double *pg, double *udg, double *uh, double *nl, double *param, double time, int ng, int nc, int ncu, int nd, int ncd)
{
	...
	for (int i = 0; i <ng; i++) {
		...
		double t5 = u6+u10;
		double t6 = u9+u11;
		fh[0*ng+i] = param3*(u1-uh1)+nl1*(t3+param1*u4*2.0)+nl2*param1*t4+nl3*param1*t5;
		fh[1*ng+i] = param3*(u2-uh2)+nl2*(t3+param1*u8*2.0)+nl1*param1*t4+nl3*param1*t6;
		fh[2*ng+i] = param3*(u3-uh3)+nl3*(t3+param1*u12*2.0)+nl1*param1*t5+nl2*param1*t6;
...
void fhatonly_ledisp3d(double *fh, double *pg, double *udg, double *uh, double *nl, double *param, double time, int ng, int nc, int ncu, int nd, int ncd)
{
	double param1 = param[0];
	double param2 = param[1];
	double param3 = param[2];
