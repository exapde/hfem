...
#include "fbou_ledisp2d.c"
#include "fbou_ledisp3d.c"
...
void fbou_ledisp(double *f, double *f_udg, double * f_uh, double *pg, double *udg, double *uhg, 
...
{    
    ...
    switch (nd) {
        case 2:            
            fbou_ledisp2d(f, f_udg, f_uh, pg, udg, uhg, nl, ui, param, time, ib, numPoints, nc, ncu, nd, ncd);            
            break;
        case 3:
            fbou_ledisp3d(f, f_udg, f_uh, pg, udg, uhg, nl, ui, param, time, ib, numPoints, nc, ncu, nd, ncd);
            break;
        default:
            exit(-1);
            break;
