void flux_ledisp3d(double *f, double *f_udg, double *pg, double *udg, double *param, double time, int ng, int nc, int ncu, int nd, int ncd)
{
	...
	for (int i = 0; i <ng; i++) {
		...
		double t8 = u9+u11;
		double t9 = param1*t8;
		f[0*ng+i] = t5+param1*u4*2.0;
		f[1*ng+i] = t3;
		f[2*ng+i] = t7;
		f[3*ng+i] = t3;
		f[4*ng+i] = t5+param1*u8*2.0;
		f[5*ng+i] = t9;
		f[6*ng+i] = t7;
		f[7*ng+i] = t9;
		f[8*ng+i] = t5+param1*u12*2.0;
...
void fluxonly_ledisp3d(double *f, double *pg, double *udg, double *param, double time, int ng, int nc, int ncu, int nd, int ncd)
{
	double param1 = param[0];
	double param2 = param[1];
	double param3 = param[2];
